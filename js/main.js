...
function loadMusicScript() {
  if (typeof localMusic === 'undefined' || !Array.isArray(localMusic) || localMusic.length === 0) {
    ...
    script.src = 'https://fastly.jsdelivr.net/gh/booskt/HeoMusic/js/Meting2.min.js';
    document.body.appendChild(script);
  } else {
    // 否则加载 localEngine.min.js
    var script = document.createElement('script');
    script.src = 'https://fastly.jsdelivr.net/gh/booskt/HeoMusic/js/localEngine.min.js';
    document.body.appendChild(script);
    local = true;
  }
}
